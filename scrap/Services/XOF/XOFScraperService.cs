...
//         private readonly ExchangeRateScraper _exchangeRateScraper;

//         public XOFScraperService(
//             HttpClient httpClient,
//             HttpClientProvider htmlProvider,
...
//             string urlByDay = $"{baseUrl}s?dateJour={date.Year}-{date.Month}-{date.Day}";

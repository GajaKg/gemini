...
public class ExchangeRatesController : ControllerBase
{
    ...
    {
        var rates = await _exchangeRateService.GetRatesByCurrencySourceAndTargetId(rateQueryParams.Id, rateQueryParams.TargetCurrencyId, rateQueryParams, cancellationToken);
